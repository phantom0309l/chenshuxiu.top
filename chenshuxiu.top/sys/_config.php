...
$ipdev = "10.25.179.16"; // fangcundev, 开发测试库 fcqxdb, statdb, xworkdb
$ip001 = "10.172.220.86"; // fangcun001, 生产环境从库, 暂时没用
$ip002 = "10.170.176.163"; // fangcun002, 旧生产环境主库, xworkdb
$ip003 = "10.30.95.230"; // fangcun003, 新生产环境主库, fcqxdb, statdb
$ipdata = "10.29.129.160"; // fangcundata,数据统计
...
// actldata，爱可泰隆库
$config["database"]["actldata"] = [];
// actldata master
$config["database"]["actldata"]["master"] = [
    'db_host' => $fcqxdb_ip,
    "db_database" => "actldata",
    "db_username" => "fcdev",
    "db_password" => "fcdev",
    "db_port" => "3306"
];
...
// actldata slaves
$config["database"]["actldata"]["slaves"] = [];
$config["database"]["actldata"]["slaves"][] = [
    'db_host' => $statdb_ip,
    "db_database" => "actldata",
    "db_username" => "fcdev",
...
$config['upload_uri'] = "http://10.29.129.160:9096/upload";
...
$config['tel_cancer'] = '010-60648881';
$config['tel_multdisease'] = '01060641115';

//商户平台号
$config['mchid_adhd'] = '1248427301';
$config['mchid'] = '1497250822';
...
$config['suggest_patient_host'] = "http://fangcun002:9099/suggest/patient/";

// 下载服务地址
$config['dl_uri'] = "http://tool.{$domain}/download";

// 统计平台接口地址(统计数据线下线上共用一个地址)
$config['tj_uri'] = "http://10.172.220.86:9090";
...
$config['cdr_cno_ys_pwd'] = 'fcys1q2w3e';
