...
class Checkup_Yizhu
{
    ...
    {
        $json_string = file_get_contents("/tmp/checkups/1013.txt");
        $yizhus = json_decode($json_string, true);
        ...
        foreach ($yizhus as $b) {
            ...
            foreach ($b as $a) {
                ...
                //使用静态工厂生成对象
                $checkup = CheckupFactory::produceYizhu();
...
$checkup_Yizhu = new Checkup_Yizhu();
$checkup_Yizhu->dowork();
