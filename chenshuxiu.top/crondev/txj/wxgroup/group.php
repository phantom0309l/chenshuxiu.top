...
//$sql = "select id from wxusers where wxshopid=1 and doctorid in (179,153,25,24,53,483,432,268,394,438,111,286,96,98) and subscribe=1 and createtime <= '2017-05-01'";
//$sql = "select * from wxusers where id=97";
...
foreach ($result as $aa) {
    ...
    $fields = array(
        "openid_list" => $aa,
        "to_groupid" => 134); //122:帅澜 126:mall 104 : 艾思瑞170330
