...
$sql = "select id from wxusers where wxshopid=1 and doctorid in (179,153,268,394,438) and subscribe=1 and createtime < '2017-05-01'";
$openid_list = array();
...
foreach ($result as $aa) {
    ...
    $fields = array(
        "openid_list" => $aa,
        "to_groupid" => 133); //122:帅澜 126:mall 104 : 艾思瑞170330
