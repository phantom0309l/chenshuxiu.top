...
class Output_3344_01
{

    public function dowork () {
        $unitofwork = BeanFinder::get("UnitOfWork");

        $sql = "select id from patients where createtime > '2017-01-01' and createtime < '2017-02-27' and status=1 and diseaseid=1 and doctorid not in (10,11)";
...
echo "\n\n-----begin----- " . XDateTime::now();
Debug::trace("=====[cron][beg][Output_3344_01.php]=====");

$process = new Output_3344_01();
$process->dowork();

Debug::trace("=====[cron][end][Output_3344_01.php]=====");
Debug::flushXworklog();
echo "\n-----end----- " . XDateTime::now();
