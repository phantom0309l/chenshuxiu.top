...
//催评估后14天没做，提醒用户7天后不活跃出组
class DrugScaleNoticeLilly
{
    ...
    public function getSendContent ($patient) {
        $name = $patient->name;
        $str = "{$name}家长，这是您被关闭向日葵关爱行动服务前的最后一次提醒，由于您在长达21天的时间内未能按要求完成孩子的用药和评估更新，系统将于7天后关闭您全部的项目相关服务。";
        return $str;
    }
...
$process = new DrugScaleNoticeLilly(__FILE__);
