...
class Check_cnt_xobjlogs_1
{
    ...
    public function dowork () {
        ...
        foreach ($tablenos as $to_month) {
            ...
            $sql = "select count(*) from statdb.objlogs where xunitofworkid >= {$fromid} and xunitofworkid < {$toid}";
            $cnt_statdb = Dao::queryValue($sql, [], 'statdb');

            $sql = "select count(*) from xworkdb.xobjlogs{$from_month}";
...
$process = new Check_cnt_xobjlogs_1();
$process->dowork();
echo "\n";
